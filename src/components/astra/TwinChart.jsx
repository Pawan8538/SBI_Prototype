...
import { ComposedChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, ReferenceArea, ReferenceDot } from 'recharts';
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 min-h-0">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={CHART_DATA} margin={{ top: 5, right: 8, left: -22, bottom: 0 }}>
            ...
            <ReferenceDot
              ...
              strokeWidth={2}
            />
            <Line type="monotone" dataKey="actual" stroke="#7c3aed" strokeWidth={2} dot={false} isAnimationActive={false} name="actual" />
            <Line type="monotone" dataKey="projected" stroke="#ef4444" strokeWidth={1.5} strokeDasharray="5 3" dot={false} isAnimationActive={false} name="projected" />
          </ComposedChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className="flex gap-4 mt-2 shrink-0">
        <span className="flex items-center gap-1 text-[10px] text-gray-500">
          <span className="inline-block w-5 h-0.5 bg-purple-600" /> Current
        </span>
        <span className="flex items-center gap-1 text-[10px] text-gray-500">
